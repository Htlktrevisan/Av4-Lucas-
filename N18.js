...
alert("Programa feito para mostar um tabuleiro com a combinação de moeda e dado")

//Entrada de Dados
moeda = Number(prompt("Digite o lado da moeda \n [1]-Cara\n [2]-Coroa"))
dado = Number("Digite quantidade tirada no dado [1 a 6]")

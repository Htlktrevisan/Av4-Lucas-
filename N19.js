...
alert("Programa para fazer um nutricionista para controlar a dieta de um paciente") 
...
alimento1 = prompt('Digite o nome do alimento 1')
rAlimento1 = prompt('O alimento '+alimento1+' contém algo? \n[1]-Glutén\n[2]-Lactose\n[3]-Nada')

alimento2 = prompt('Digite o nome do alimento 2')
rAlimento2 = prompt('O alimento '+alimento2+' contém algo? \n[1]-Glutén\n[2]-Lactose\n[3]-Nada')

alimento3 = prompt('Digite o nome do alimento 3')
